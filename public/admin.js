...
function shiftModal(s) {
  ...
  const body = [
    ...
    el('div', {}, el('label', {}, 'Cửa sổ nhận diện ca theo GIỜ CHẤM VÀO (tuỳ chọn — để tự tìm đúng ca)'),
      ...
      el('div', { class: 'map-hint' }, 'Đây là MỘT khoảng giờ (từ → đến) để tự nhận đúng ca khi nhân viên chấm VÀO. VD ca sáng 06:00→10:00, ca chiều 12:00→15:00. Lúc chấm RA không cần khai — hệ thống dùng lại ca đã nhận lúc vào.')),
    el('div', { class: 'two-col' },
